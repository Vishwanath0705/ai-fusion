export default [
    ...
    {
        model: 'Gemini', icon: '/gemini.png', premium: false, enable: true, subModel: [{ name: 'Gemini 2.5 Lite', premium: false },
        { name: 'Gemini 2.5 Flash', premium: false }, { name: 'Gemini 2.5 Pro', premium: true }]
    },
    {
        model: "DeepSeek",
        icon: "/deepseek.png",
